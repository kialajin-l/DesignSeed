...
**一句话**：OpenPencil 是"专业设计师的 AI 工具"，DesignSeed 是"让任何人都能做出独特设计的 AI 工具"。
...
**目标**：实现 AI 驱动的原型设计生成能力，从"静态 HTML 模板"升级到"AI 理解需求 → 生成可交互原型"。
...
**目标**：构建前端 GUI 框架，预留 Cove 画布接入接口，实现"AI 生成 + 实时预览 + 点击编辑"的完整体验。

**预计时间**：2026-06 中旬 ~ 2026-07 上旬（3 周）

**核心原则**：前端页面做好布局和接口，Cove 画布的具体实现由 Cove 团队决定接入方式。
